                        ...
                        <div class="card-body">
                            <form action="/admin/product/add" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="condition" value="0">
                                        <label class="form-check-label" for="status">
                                            Cũ
                                        </label>
                                    </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <select name="guarantee_id" id="" class="form-select form-control">
                                        ...
                                        @foreach($guarantee as $key)
                                            <option value="{{$key->id}}">{{$key->guarantee_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="camera">
                                    </div>
