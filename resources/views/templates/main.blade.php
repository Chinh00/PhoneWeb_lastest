                                ...
                                <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                    <form action="/register" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="register-email" name="last_name" required>
                                        </div><!-- End .form-group -->
                                        <div class="form-group">
                                            <label for="register-email">Họ</label>
                                            <input type="text" class="form-control" id="register-email" name="first_name" required>
                                        </div><!-- End .form-group -->
                                        <div class="form-group">
